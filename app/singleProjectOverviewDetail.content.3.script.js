...
return new ModuleArray([
    ...
    new ElementModule("div",{html:item.hasDeadline()?(d+" day"+(d==1?"":"s")+" left until deadline, "+item.getDeadlineDate()):"There is no deadline set for this project", "class":"percent-complete-value"}),
