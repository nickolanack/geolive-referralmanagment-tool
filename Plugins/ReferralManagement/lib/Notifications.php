...
class Notifications {
	...
	public function onProfilePendingValidation($json){

		$this->postEventFeeds('guest.profile.validating', array(
			"items" => array(
				array(
					"type" => "guest",
					"id" => 0,
	...
	public function onProfileApproval($json){

		$this->postEventFeeds('guest.profile.approval', array(
			"items" => array(
				array(
					"type" => "guest",
					"id" => 0,
