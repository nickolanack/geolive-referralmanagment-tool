							...
							click: function() {
								...
								(new AjaxControlQuery(CoreAjaxUrlRoot, 'get_qr_code', {
									...
									(new UIModalDialog(application, new MockDataTypeItem({
										name:`<div class="mobile-qr"><h2>Scan this code with the field assessment app</h2><span class="ios">IOS:</span> <a target="_blank" href='https://testflight.apple.com/join/rPVA9ODg'>Become an open beta tester for IOS</a><br/>
										<span>Android:</span> <a target="_blank" href='https://play.google.com/apps/testing/org.nickolanack.gatherapp'>Become an open beta tester for Android</a></div>`,
										image:resp.qrcode
									}), {
										"formName": "dialogForm",
										"formOptions": {
