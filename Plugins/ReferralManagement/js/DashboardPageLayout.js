var DashboardPageLayout = (function() {
	...
	var layout = new DashboardPageLayout().addLayout('mainDashboardDetail', function(content) {
		...
		content=layout.filterIdentifierConfig(content, ['project-related-projects', 'project-response-date','proponent-edit-btns', 'proposal-status', 'status-assessment', 'status-processing'], 'enableProposals');
